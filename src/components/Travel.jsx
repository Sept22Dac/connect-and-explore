...
const Travel = () => {
  ...
  //  const fixedImg="http://localhost:8080/travels/1/image"
    ...
    return (
        ...
        <h1 className="text-center border bg-dark text-warning">Travel Page</h1>
        ...
        <div className="container mx-5 my-3">
            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <Link tag='a'  to="/travel/viewTravel" class="list-group-item list-group-item-action">View All Travel Events</Link>
                    <Link tag='a' to="/travel/addTravel" class="list-group-item list-group-item-action">Create a Travel Event</Link>

...
const Sport = () => {
  ...
  return (
    <div className="my-2">
      <h1 className="text-center border bg-dark text-warning">Sport Events</h1>
      ...
      <div className="container mx-5 my-3">
        ...
        <div class="row">
          <div class="col-3">
            ...
            <Link
              tag="a"
              to="/sport/ViewCricket"
              class="list-group-item list-group-item-action"
            >
              View All Cricket Events
            </Link>
            <Link
              tag="a"
              to="/sport/viewBadminton"
              class="list-group-item list-group-item-action"
            >
              View All Badminton Events
            </Link>
            <Link
              tag="a"
              to="/sport/addSport"
          ...
          <div class="col-9">
            <Routes>
              ...
              <Route
                path="/viewFootball"
                element={<SportList stype="FOOTBALL" />}
              />
              <Route
                path="/viewCricket"
                element={<SportList stype="CRICKET" />}
              />
              <Route
                path="/viewBadminton"
                element={<SportList stype="BADMINTON" />}
              />

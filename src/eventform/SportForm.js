...
export default function SportForm() {
    ...
    const addSport=(e)=>{
        ...
        if (!sport.stype || !sport.location|| !sport.date|| !sport.name|| !sport.required) {
            return;
          }
    ...
    <div className="container mt-3">
        ...
        <form onSubmit={(e) => addSport(e)}
          ...
          className={submitted ? "was-validated" : ""}>
            ...
            <input type="text" value={sport.location} onChange={handleChange} class="form-control" id="location" name="location" required/>
            ...
            &nbsp; &nbsp;
            <input type="datetime-local" value={sport.date} onChange={handleChange} id="date" name="date" required/>
            <div className="invalid-feedback">Date & Time is required.</div>
            </div>

            <div class="form-group">
            <label for="capacity">Maximum number of participants</label>
            <input type="number" value={sport.required} onChange={handleChange} class="form-control" id="capacity" name="required" required/>
            <div className="invalid-feedback">Capacity is required.</div>
            </div>

            <div class="form-group">
            <label for="description">Details :</label >
            <textarea rows={3} value={sport.name} onChange={handleChange} class="form-control" id="description" name="name" placeholder="Enter Details Like Name of Person, Contact details, price per person (if valid) etc" required/>

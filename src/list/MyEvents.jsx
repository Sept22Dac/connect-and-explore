...
const MyEvents = () => {
  ...
  useEffect(() => {
    ...
    ConcertService.getAllCreatedConcerts(currentUser?.user_id).then(
      (response) => {
        setConcertList(response.data);
      }
    );
    SportService.getAllCreatedSports(currentUser?.user_id).then((response) => {
      setSportsList(response.data);
    });
    TravelService.getAllCreatedTravels(currentUser?.user_id).then(
      (response) => {
